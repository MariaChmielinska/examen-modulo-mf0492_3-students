...
app.get('/check', async (req, res) => {
    ...
    if (!ssn) {
        return res.status(400).send('Por favor, proporcione un número de la seguridad social');
    }
    try {
        ...
        logRequest(`Se ha realizado una consulta sobre un paciente con SSN: ${ssn}`);
